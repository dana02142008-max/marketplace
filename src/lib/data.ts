...
export const mockProducts: Product[] = [
  { id: 'p1', title: 'MacBook Pro 14" M3 Pro — Excellent condition', description: 'Selling my MacBook Pro 14-inch with M3 Pro chip. Only used for 6 months, still in excellent condition. Includes original box and charger. Perfect for developers and creatives.', price: 18500, originalPrice: 26000, currency: 'SEK', images: productImages.electronics, category: 'electronics', subcategory: 'Laptops', condition: 'like_new', seller: mockUsers[1], location: 'Gothenburg', distance: '2.4 km', createdAt: '2024-07-10', views: 2341, saves: 89, isNegotiable: true, hasDelivery: true, deliveryPrice: 149, isFeatured: true, isVerified: true, tags: ['apple', 'macbook', 'laptop', 'm3'], brand: 'Apple', priceHistory: [{ date: '2024-06-01', price: 20000 }, { date: '2024-07-01', price: 19000 }, { date: '2024-07-10', price: 18500 }] },
  { id: 'p2', title: 'Nike Air Jordan 1 Retro High OG — Size 43', description: 'Deadstock Jordan 1s in Chicago colorway. Never worn, kept in original box. Bought directly from Nike, have receipt.', price: 4200, originalPrice: 1800, currency: 'SEK', images: productImages.fashion, category: 'fashion', subcategory: 'Shoes', condition: 'new', seller: mockUsers[0], location: 'Stockholm', distance: '0.8 km', createdAt: '2024-07-12', views: 1890, saves: 234, isNegotiable: false, hasDelivery: true, deliveryPrice: 89, isFeatured: true, isVerified: true, tags: ['nike', 'jordan', 'sneakers', 'deadstock'], brand: 'Nike', priceHistory: [] },
  { id: 'p3', title: 'Vintage Danish Teak Sofa — 1960s', description: 'Beautiful original Danish teak sofa from the 1960s. Recently reupholstered in premium boucle fabric. Solid frame, no wobble. A true mid-century masterpiece.', price: 8900, currency: 'SEK', images: productImages.home, category: 'home', subcategory: 'Sofas', condition: 'good', seller: mockUsers[4], location: 'Linköping', distance: '45 km', createdAt: '2024-07-08', views: 987, saves: 156, isNegotiable: true, hasDelivery: false, isFeatured: false, isVerified: false, tags: ['vintage', 'danish', 'teak', 'midcentury'], priceHistory: [] },
  { id: 'p4', title: 'PlayStation 5 + 3 Games Bundle', description: 'PS5 disc edition in perfect condition. Selling due to moving. Includes 3 top games: God of War Ragnarök, Spider-Man 2, Hogwarts Legacy. All cables and controller included.', price: 7200, originalPrice: 10500, currency: 'SEK', images: productImages.gaming, category: 'gaming', subcategory: 'Consoles', condition: 'like_new', seller: mockUsers[3], location: 'Uppsala', distance: '12 km', createdAt: '2024-07-11', views: 3421, saves: 412, isNegotiable: true, hasDelivery: true, deliveryPrice: 199, isFeatured: true, isVerified: true, tags: ['ps5', 'playstation', 'games', 'bundle'], brand: 'Sony', priceHistory: [{ date: '2024-07-05', price: 7800 }, { date: '2024-07-11', price: 7200 }] },
  { id: 'p5', title: 'iPhone 15 Pro Max 256GB — Natural Titanium', description: 'iPhone 15 Pro Max in Natural Titanium, 256GB. Face ID works perfectly. Battery health at 98%. Complete with original box and all accessories including unused EarPods.', price: 12500, originalPrice: 16995, currency: 'SEK', images: productImages.phones, category: 'phones', subcategory: 'iPhones', condition: 'like_new', seller: mockUsers[2], location: 'Malmö', distance: '8 km', createdAt: '2024-07-09', views: 4567, saves: 678, isNegotiable: false, hasDelivery: true, deliveryPrice: 99, isFeatured: true, isVerified: true, tags: ['iphone', 'apple', 'pro', 'titanium'], brand: 'Apple', priceHistory: [{ date: '2024-06-15', price: 13500 }, { date: '2024-07-09', price: 12500 }] },
  { id: 'p6', title: 'Sony WH-1000XM5 Wireless Headphones', description: 'Industry-best noise cancelling headphones. Barely used, bought 3 months ago. Comes with all original accessories and case. Multipoint connection, 30hr battery life.', price: 2800, originalPrice: 4299, currency: 'SEK', images: [productImages.electronics[3]], category: 'electronics', subcategory: 'Headphones', condition: 'like_new', seller: mockUsers[1], location: 'Gothenburg', distance: '3.1 km', createdAt: '2024-07-13', views: 1234, saves: 89, isNegotiable: true, hasDelivery: true, deliveryPrice: 79, isFeatured: false, isVerified: true, tags: ['sony', 'headphones', 'wireless', 'anc'], brand: 'Sony', priceHistory: [] },
  { id: 'p7', title: 'Acne Studios Wool Blazer — Size M', description: 'Beautiful Acne Studios blazer in charcoal grey wool. Season 2023. Worn once to a wedding. Perfect condition, no alterations.', price: 3200, originalPrice: 6500, currency: 'SEK', images: [productImages.fashion[2]], category: 'fashion', subcategory: 'Men', condition: 'like_new', seller: mockUsers[2], location: 'Malmö', distance: '8 km', createdAt: '2024-07-07', views: 789, saves: 67, isNegotiable: true, hasDelivery: true, deliveryPrice: 89, isFeatured: false, isVerified: true, tags: ['acne studios', 'blazer', 'wool', 'designer'], brand: 'Acne Studios', priceHistory: [] },
  { id: 'p8', title: 'iPad Pro 12.9" M2 + Apple Pencil 2', description: 'iPad Pro 12.9-inch M2 chip, 128GB WiFi, Space Grey. Apple Pencil 2nd gen included. Keyboard Folio case also included. Perfect for artists and professionals.', price: 9800, originalPrice: 15000, currency: 'SEK', images: [productImages.electronics[2]], category: 'electronics', subcategory: 'Tablets', condition: 'good', seller: mockUsers[0], location: 'Stockholm', distance: '1.2 km', createdAt: '2024-07-06', views: 2100, saves: 178, isNegotiable: false, hasDelivery: true, deliveryPrice: 129, isFeatured: true, isVerified: true, tags: ['ipad', 'apple', 'tablet', 'pencil'], brand: 'Apple', priceHistory: [] },
  { id: 'p9', title: 'Vintage Rolex Datejust 36 — 1985', description: 'Authentic 1985 Rolex Datejust 36mm in stainless steel with original blue dial. Service history available. Comes with period-correct oyster bracelet. All documentation.', price: 68000, currency: 'SEK', images: [productImages.fashion[0]], category: 'luxury', subcategory: 'Watches', condition: 'good', seller: mockUsers[3], location: 'Uppsala', distance: '15 km', createdAt: '2024-07-05', views: 5670, saves: 890, isNegotiable: true, hasDelivery: false, isFeatured: true, isVerified: true, tags: ['rolex', 'watch', 'vintage', 'luxury'], brand: 'Rolex', priceHistory: [] },
  { id: 'p10', title: 'Fender Stratocaster USA Standard 2019', description: 'American Standard Strat in Olympic White with maple neck. Bought new in 2019, played at home only. Includes original hardcase. Set up by a professional luthier.', price: 14500, originalPrice: 19000, currency: 'SEK', images: [productImages.electronics[0]], category: 'music', subcategory: 'Guitars', condition: 'like_new', seller: mockUsers[4], location: 'Linköping', distance: '42 km', createdAt: '2024-07-04', views: 1456, saves: 234, isNegotiable: true, hasDelivery: true, deliveryPrice: 249, isFeatured: false, isVerified: false, tags: ['fender', 'stratocaster', 'guitar', 'electric'], brand: 'Fender', priceHistory: [] },
  { id: 'p11', title: 'Herman Miller Aeron Chair — Size B', description: 'Herman Miller Aeron chair in graphite, size B. Tilt limiter, lumbar support, adjustable arms. Like new condition, bought for home office. Best investment for your back.', price: 11500, originalPrice: 22000, currency: 'SEK', images: [productImages.home[1]], category: 'home', subcategory: 'Tables', condition: 'like_new', seller: mockUsers[1], location: 'Gothenburg', distance: '4.5 km', createdAt: '2024-07-03', views: 3210, saves: 345, isNegotiable: false, hasDelivery: false, isFeatured: true, isVerified: true, tags: ['herman miller', 'aeron', 'chair', 'ergonomic'], brand: 'Herman Miller', priceHistory: [] },
  { id: 'p12', title: 'Canon EOS R6 Mark II + RF 24-105mm', description: 'Canon EOS R6 Mark II body with RF 24-105mm f/4L lens. Only 3,400 shutter actuations. Perfect for videography and photography. Includes 2 batteries and charger.', price: 32000, originalPrice: 48000, currency: 'SEK', images: [productImages.electronics[1]], category: 'electronics', subcategory: 'Cameras', condition: 'like_new', seller: mockUsers[2], location: 'Malmö', distance: '9.2 km', createdAt: '2024-07-02', views: 2345, saves: 289, isNegotiable: true, hasDelivery: true, deliveryPrice: 199, isFeatured: true, isVerified: true, tags: ['canon', 'camera', 'mirrorless', 'eos'], brand: 'Canon', priceHistory: [] },
];
...
export function formatPrice(price: number, currency = 'SEK'): string {
  return new Intl.NumberFormat('sv-SE', { style: 'currency', currency, maximumFractionDigits: 0 }).format(price);
}
